<html>
    ...
    <body>
        ...
        <h1>Search College  a/c to your AIIMS Rank : </h1>
        <br>
        <br>
        <form action="AIIMSschool.php" method="post" onSubmit="return check()">
            <table>
                <tr>
                    <h1> MARKS IN :- </h1>
                </tr>
                ...
                <tr>
                    <td>AIIMS RANK</td><td>:</td><td><input type="text" name="t3" id="t3" size="40" pattern="([0-9]).{0,}" title="Use number." onkeyup="update()" maxlength="4"></td>
					<td>(1-2000)</td>
                </tr>
                <!--<tr>
                    <td>Stream</td><td>:</td><td><select name="t4" id="t4"><option>Select any one</option><option value="AIIMS">Aiims</option></select></td>
                </tr>-->
                <tr>
