...
$sql1 = "INSERT INTO JEEdetails VALUES('$name','$mail','$marks','$stream')";
...
else
{
    ...
    $sql = "select * from collegedetails where '".$marks."' between lowrange and highrange having stream='BTECH' ";
