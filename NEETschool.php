...
$sql1 = "INSERT INTO NEETdetails VALUES('$name','$mail','$marks','$stream')";
...
else
{
    ...
    $sql = "select * from collegedetails where '".$marks."' between lowrange and highrange having stream='MEDICAL' ";
