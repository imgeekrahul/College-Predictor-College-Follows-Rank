    ...
    <body>
        ...
        <script type="text/javascript">
            function check()
            {
                ...
                c = document.getElementById("t6").value;
                d = document.getElementById("t7").value;
                e = document.getElementById("t8").value;
        ...
        <h1>Search College  a/c to your 12th marks : </h1>
        <br>
        <br>
        <form action="12schools.php" method="post" onSubmit="return check()">
            <table>
                <tr>
                ...
                <tr>
                    <td>Mathematics</td><td>:</td><td><input type="number" min="0" name="t4" id="t4" size="100" maxlength="3" pattern="([0-9]).{1,}" title="Use number."></td>
					<td>(33-100)</td>
                </tr>
                <tr>
                    <td>Physics</td><td>:</td><td><input type="number" min="0" name="t5" id="t5" size="100" maxlength="3" pattern="([0-9]).{1,}" title="Use number."></td>
					<td>(33-100)</td>
                </tr>
                <tr>
                    <td>Chemistry</td><td>:</td><td><input type="number" min="0" name="t6" id="t6" size="100" maxlength="3" pattern="([0-9]).{1,}" title="Use number."></td>
					<td>(33-100)</td>
                </tr>
                <tr>
                ...
                <tr>
                   <td>Computer</td><td>:</td><td><input type="number" min="0" name="t8" id="t8" size="100" maxlength="3" pattern="([0-9]).{1,}" title="Use number."></td>
					<td>(33-100)</td>
                </tr> 
                <tr>
                ...
                <!--<tr>
                    <td>Stream</td><td>:</td><td><select name="t10" id="t10"><option>Select any one</option><option value="12">12</option></select></td>
                </tr>-->
                <tr>
