<html>
    ...
    <body>
        ...
        <h1>Search College  a/c to your JEE(Mains) Rank : </h1>
        <br>
        <br>
        <form action="JEEschool.php" method="post" onSubmit="return check()">
            <table>
                <tr>
                    <h1> MARKS IN :- </h1>
                </tr>
                ...
                <tr>
                    <td>JEE RANK</td><td>:</td><td><input type="text" name="t3" id="t3" size="40" pattern="([0-9]).{0,}" title="Use number." onkeyup="update()" maxlength="4"></td>
					<td>(1-2000)</td><td><div id="t5"></div></td>
                </tr>
               <!-- <tr>
                    <td>Stream</td><td>:</td><td><select name="t4" id="t4"><option>Select any one</option><option value="BTECH">B.tech</option></select></td>
                </tr> -->
                <tr>
